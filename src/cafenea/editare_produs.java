 ...
 * @author andre
 */
public class editare_produs extends javax.swing.JFrame {

    /**
     * Creates new form editare_produs
     */
    public editare_produs() {
         try { 
    ...
    private void initComponents() {
        ...
        jLabel1.setText("EDITARE PRODUS");
        ...
        jLabel8.setText("SELECTATI PRODUSUL");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(editare_produs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new editare_produs().setVisible(true);
            }
        });
    }
